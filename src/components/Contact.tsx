...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs.send(
      'service_ksawlgv',  // Replace with your EmailJS Service ID
      'template_l924lwk', // Replace with your EmailJS Template ID
      templateParams,
      '6mSKI1i3swfJ4aoi4'   // Replace with your EmailJS Public Key
    )
    .then((response) => {
  ...
  return (
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-12" data-aos="fade-down">
          Get in Touch
        </h2>
